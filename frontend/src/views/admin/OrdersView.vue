<template>
    <DashboardLayout>
        <!-- 添加一些过滤条件 -->
        <t-table row-key="order_id" :columns="columns" :data="data" table-layout="fixed" :loading="isLoading"
...
export default {
            ...
            columns: [
                ...
                },
                {
                    ...
                    cell: (h, { col, row }) => {
                        ...
                        let time = new Date(row.createDate * 1000 + (8 * 3600 * 1000)).toISOString()
    ...
    mounted() {
        this.getOrdes(this.pagination.defaultCurrent, this.pagination.defaultPageSize)
    }
